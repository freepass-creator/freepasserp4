...
1. 상품 private `5,641/4,867대 · 4,867쓰기 · 15,781삭제 · 20,648경로/52배치` 승인·실제 적용
2. 정산 private `15/12건 · 12/0/0쓰기 · 24삭제 · 36경로/1배치` 승인·실제 적용
3. 관리자 외 영업 관리자/직원·공급사 관리자/직원 실계정 격리 테스트
4. 전자서명 반려·해지·만료의 실브라우저 테스트
5. Vercel Production 배포와 도메인·로그인·모바일 스모크
