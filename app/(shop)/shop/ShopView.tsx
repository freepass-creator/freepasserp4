          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            */}
            ...
            {/*
              ...
              ★★★**칩이 있는 조건은 여기 «또» 세우지 않는다 — 웹과 같은 규칙이다.**
                사장님 2026-09-10 「웹 버전과 모바일 버전 **필터 누르는 방식이 다르다니까.**
                **퀵필터에 있는 거는 누르면 «자리»가 눌리는 거지 새로운 게 나오는 게 아니잖아**」.
                ⚠ 폰만 걸린 것을 **전부** 싣고 있었다. 그래서 「SUV」를 누르면
                  ㉠ 칩이 켜지고 ㉡ **밑에 줄이 하나 새로 생겨** 목록이 아래로 밀렸다 —
                  한 조건이 한 화면에 **두 번** 서고, 누를 때마다 화면이 들썩였다.
                ★웹은 2026-09-08 에 이미 이렇게 고쳤다(「위에 퀵버튼이 있는 거는 그게 그냥 켜지면
                  되는 거 아닌가? 거기에 **없는 거만** ✕ 로 없앨 수 있게 하면 되고」).
                  **폰만 안 따라왔다** — 규칙을 정하면 양쪽에 한 번에 적용한다(집 규칙 ③).
                ⇒ 칩으로 켠 조건은 **칩이 말하고**, 조건 시트에서만 걸 수 있는 것(제조사·연식 등)만
                  여기 와서 말한다. 한 조건 = 한 자리.
              ⚠ 「칩이 줄 밖으로 밀리면 안 보인다」가 폰에서 전부 싣던 이유였다. 그런데 **웹 칩 줄도
                똑같이 가로로 흐른다** — 웹은 09-08부터 이대로 잘 돌았다. 게다가 방금 «누른» 칩은
                손가락 밑에 있어 안 보일 수가 없다. 안 보이는 경우는 「전에 걸어 두고 줄을 밀어 놓은
                것」뿐인데, 그때는 **건수(「검색 228대」)가 이미 「뭔가 걸려 있다」를 말한다.**
                ⇒ 자동으로 굴려서 풀지 않는다 — 화면이 저 혼자 움직이는 것이야말로 사장님이 싫어하신
                  그 「들썩임」이다. 같은 말을 두 번 적는 것으로도 풀지 않는다.
            */}
            {mobile ? (
