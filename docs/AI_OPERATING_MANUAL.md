...
| ④′ 공급사 「상품시트」 | 중앙 판매시트에서 해당 공급사 행을 현재 61열·1대=1행으로 그대로 복제한다. 머리글 이름·순서·행 전체가 모두 같아야 하며, 공급사 전용 열을 빼거나 더하지 않는다. | npx tsx scripts/publish-supplier-preview-tabs.mts --apply |
