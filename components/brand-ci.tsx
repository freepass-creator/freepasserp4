 ...
 * ★★**세로는 «캡 밴드 가운데»** 다(사장님 2026-09-07 「**심볼 가운데 텍스트가 정확히 들어가서
 *   가로로 배열**되어야 함」). 공식 원본은 «세로 적층»이고 머리띠는 그것을 가로로 눕힌 변형이라,
 *   그때 지켜야 할 것이 **심볼의 세로 중심 = 글자의 세로 중심**이다.
 * ⚠ «글자의 중심»은 줄상자 가운데가 **아니다** — 대문자뿐이라 밑으로 내려가는 획이 없어 둘이
 *   어긋난다(`CAP_NUDGE`). 줄상자에 맞추면 심볼이 «떠» 보인다. 실측 어긋남 0.00px.
 */
