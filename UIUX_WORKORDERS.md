...
| 화면 | ① 주제 | ② 식별 | ③ 맥락 | 우측① | 우측③ |
|---|---|---|---|---|---|
| **홈·재고**(매물) | 차량명 | 차번 · 연식 · 연료 · 주행 · 배기량 | 우대·이벤트 / 공급사 | 가격 · 상태 | — |
| **문의** | 차량명 | 상태뱃지 · **차번** · 상대방 | 마지막 메시지 | 시각 | 안읽음 |
| **계약** | 차량명 | 상태뱃지 · 차번 · 계약코드 | 계약자 · 계약일 | 진행 n/5 | — |
| **정산** | 차량명 | 상태뱃지 · 차번 · 정산월 | 금액 | 상태 | — |
| **회원** | 이름 | 코드 · 소속 | 역할 · 연락처 | 상태 | — |
