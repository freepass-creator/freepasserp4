...
const policy = { basic_driver_age: 26, driver_age_lowering: '만 21세까지', age_lowering_cost: 100000 } as EntityRecord;
...
assert.deepEqual(contractDriverAgeOptions(policy), [
  { age: 26, label: '만 26세 이상', surcharge: 0 },
  { age: 21, label: '만 21세 이상', surcharge: 100000 },
]);
