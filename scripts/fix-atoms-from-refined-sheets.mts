 ...
 *   (상품리스트 103 · 손오공상품 39 · 픽업구독 14 · 오플구독 44 — 원문에는 전부 글자가 있었다:
 ...
 *   ⑯ 본시트 발행이 `product_type` 으로 탭을 가르는데(`픽업구독`·`손오공상품`·`오플구독`·나머지),
...
for (const [key, v] of Object.entries(products)) {
  ...
  // ★외장/내장 색이 «한 칸에 붙은」 것 분리 — 「A / B」 → 외장=A · 내장=B (손오공상품 등, 사장님 2026-09-04).
