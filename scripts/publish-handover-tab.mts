...
const ROWS: Row[] = [
  ...
  ['', '오공구독', '손오공의 반납받아 보유 중인 물량. 픽업구독은 사오는 물량이며 별도 상품으로 구분한다. 상품리스트와 같은 규격 + 인수형 요금.'],
  ...
  ['', '오공구독', 'npx tsx scripts/publish-origin-tab.mts --only=RP012:구독 --tab=오공구독 --at=1 --apply → npx tsx scripts/publish-sonogong-tab.mts --apply'],
  ...
  ['', '③ 두 벌 금지', '같은 차가 두 탭에 서면 사고다. 오플·오공구독은 상품리스트에서 뺀다.'],
  ...
  ['7. 판매 차명', '정본', '공급사 시트의 **완성된 정제칸** 값을 그대로 쓴다. 발행 단계에서 상품마스터를 거치거나 차명을 다시 정제하지 않는다.'],
  ...
  ['', '오공구독·요금 블록', 'scripts/publish-origin-tab.mts · scripts/publish-sonogong-tab.mts'],
