...
const ROWS: Row[] = [
  ...
  ['', '축', '제조사 · 모델 만. 「차명」은 공급사 「차명(트림)」 원문. ★세부모델·세부트림·파워트레인은 뺐다 — @매핑에 다시 적어도 발행기가 세우지 않는다(SALES_RETIRED_COLUMNS).'],
  ...
  ['', '28열', '차량번호 | 입고일자 | 상태 | 분류 | 제조사 | 차명(트림) | 옵션 | 외부색상 | 내부색상 | 연식 | 주행거리 | 연료 | 배기량 | 차량가격 | 단기보증 | 1개월 | 12개월 | 장기보증 | 24개월 | 36개월 | 48개월 | 60개월 | 기타기간①②③ | 정책코드 | 최초등록일 | 사진링크  (2026-08-18 사장님 통일 · 웰릭스 표준 · 20곳 재정렬)'],
