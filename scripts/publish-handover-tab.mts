...
const ROWS: Row[] = [
  ...
  ['5. 서식 (실측값)', '글꼴', 'Roboto 9pt · 기울임 없음 · 기본 흰 바탕 · 행높이 22px · 테두리 없음 · 줄무늬 없음'],
  ...
  ['', '★색의 역할', '기본 바탕은 흰색. 기간/보증금 블록만 배경색으로 가르고, 상태·구분·링크 같은 값 변화는 글자색으로 가른다.'],
  ...
  ['', '굵게', '금액은 전부: 월 대여료 · 보증금 · 차량가격. 2026-08-19 확정 규격이며 기간/보증 구분은 배경색으로 낸다.'],
  ['', '', ''],
