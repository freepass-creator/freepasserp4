...
// ── 7. 공급사 차명 표기(2026-08-21) — 마스터에 있는 차를 표기 때문에 못 붙이면 안 된다 ──
{
  const cases: { label: string; rec: Record<string, unknown>; want: { model: string; sub?: string } }[] = [
    ...
    { label: '신형K5 렌터카', rec: { maker: '기아', model: 'K5', vehicle_name: '신형K5 2.0 렌터카 스탠다드', year: 2021, fuel_type: 'LPG' }, want: { model: 'K5', sub: 'K5 DL3' } },
    { label: '디 올 뉴 니로', rec: { maker: '기아', model: '니로', vehicle_name: '디 올 뉴 니로 하이브리드 1.6 프레스티지', year: 2023 }, want: { model: '니로', sub: '니로 SG2' } },
    { label: '디 올 뉴 코나', rec: { maker: '현대', model: '코나', vehicle_name: '디 올 뉴 코나 SX2 가솔린 1.6T 2WD 모던', year: 2024 }, want: { model: '코나', sub: '코나 SX2' } },
