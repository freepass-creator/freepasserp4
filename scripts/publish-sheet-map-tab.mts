...
row('', '「프리패스 상품리스트」(판매시트)', '영업자가 보는 표이자 ERP 직접 정본. 탭 3개: 상품리스트 · 오공구독(반납형+인수형 기간별 금액) · 오플구독(연 2만km 기본, **12개월만 3만km**, 12개월 2만km 없음). 폐기된 오플프로모션 탭은 ERP가 읽지 않는다. 같은 차는 한 탭에만.', url(SALES));
...
row('', '④ 오공구독·오플구독 탭', '손오공은 반납형·인수형 기간별 금액을 모두 보존한다. 오플은 연 2만km 기본·12개월만 3만km이며 폐기 프로모션 탭은 제외한다.', 'sales-published-tabs');
