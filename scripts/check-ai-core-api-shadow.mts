...
assert.ok(route.includes("return { kind: 'VERSION_MISMATCH' as const, actual_revision: actualRevision };"));
...
assert.ok(route.includes('actual_revision: guarded.actual_revision'));
