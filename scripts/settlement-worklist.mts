...
show('이달청구', '지난 달 인도분 — 이 달 안에 청구해야 한다', '영업자 확인을 받고 이 달 안에 발행한다');
// ★마감 대기는 «정상»이다. 몇 건인지만 말한다 — 매달 수십 건이 문제처럼 뜨면 진짜 늦은 건이 묻힌다.
show('마감대기', '이 달 인도분 — 말일 마감 뒤 다음 달 초에 청구한다', '아직 달이 안 끝났다. 지금은 둔다');
