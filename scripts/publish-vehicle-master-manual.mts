...
const rows = [
  ...
  ['한글 표기', '일반 영문 단어는 한글화하되 전체 대문자 공식 트림·약어·개발코드·고유명은 원문 유지', 'Premium → 프리미엄, Black Exterior → 블랙 익스테리어 / VIP PACK·FLUX·GN11·AWD·N Line 유지', '공식 한글 근거 또는 시장 표기 확인'],
  ['트림 별칭', '동일 표현은 하나의 정본으로 통합하고 원문은 별칭 보존', 'N라인·엔 라인 → N Line', 'N과 N Line은 서로 합치지 않음'],
