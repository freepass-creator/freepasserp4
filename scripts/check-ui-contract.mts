...
const RAW_ALLOW = new Map<string, Allow>([
  ...
  ['app/sign/[token]/page.tsx', { all: true, reason: 'ERP 업무 셸 밖 손님 전자서명 폼 섬 — B2C 전용 sign 원자의 네이티브 입력·선택·서명 동작' }],
  ['components/sign/atoms.tsx', { all: true, reason: '손님 전자서명 전용 B2C 원자 — ERP 공용 컨트롤과 의도적으로 다른 터치·폼 규격' }],
