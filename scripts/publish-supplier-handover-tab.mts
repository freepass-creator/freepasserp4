...
const NOTES: Record<string, string[]> = {
  아이카: ['자체시트를 쓰는 곳이다. 이 시트는 그 원본을 우리 규격으로 옮겨 담은 «규격화시트»다.',
    ...
    '★2026-08-14 문패(공급사시트정리)를 이 시트로 돌렸다. 영업자 시트는 이제 여기서 읽는다.',
    '★되돌리려면 문패 RP004 줄 주소를 원본(1LqWVs2o…)으로 되돌리면 된다.',
    '⚠ 그래서 sync-mirror-sheet 가 멈추면 영업자가 옛 값을 본다. @이력을 보고 며칠 됐는지 확인하라.'],
