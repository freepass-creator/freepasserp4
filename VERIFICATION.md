...
- 오픈 전 필수 잔여는 ① 개인정보 보호책임자 확정·입력과 공개 문서 최종 확인 ② Preview 기존회원 재동의 1회 ③ 5역할 실계정 읽기·쓰기 smoke ④ 사람/Claude 후보 Rules 실데이터 승인·게시·게시후 smoke ⑤ 관리자 아이언 49/24/25·21/3/4 확인 후 28건 반영과 활성 24대·Sheet 제외·감사로그 확인 ⑥ Production 서비스계정·플래그·최종 배포다. 실제 게시가 지연되면 직전에 백업을 다시 갱신한다.
