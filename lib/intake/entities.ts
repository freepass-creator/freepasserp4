...
/**
 * 상품구분 캐논 — 렌트/구독 × 신차/중고, 그리고 «공급사별 구독» 셋: **오플구독·픽업구독·오공구독**.
 *   ★7캐논(사장님 2026-09-08): 신차렌트·중고렌트·신차구독·중고구독·오플구독·픽업구독·오공구독.
 *   ★★**상품구분은 불변이 아니다 — 라이프사이클로 바뀐다**: 픽업구독→(부러져 재판매)→오공구독 ·
 *     신차렌트→(반납)→중고렌트. write-once 로 굳히지 말 것.
 *
 * ★**픽업구독은 중고구독이 아니다**(사장님 2026-08-28). 손오공 T카(신규)에서 오는 별개 갈래이고
 *   판매시트도 「픽업구독」 탭을 따로 낸다(sales-published-tabs).
 *   ★**오공구독** = 손오공 픽업이 부러져 손오공이 자체보유·재판매하는 중고구독(사장님 2026-09-08 「4글자로 오공」).
 *   ★**오플구독** = 오토플러스 구독(RP023). 셋 다 중고구독과 색·아이콘을 가른다(`productTypeStyle`).
 *
 ...
 */
export const PRODUCT_TYPES = ['신차렌트', '중고렌트', '신차구독', '중고구독', '오플구독', '픽업구독', '오공구독'] as const;
...
export const PRODUCT_TYPE_LEGACY: Record<string, typeof PRODUCT_TYPES[number]> = {
  ...
  재구독: '중고구독', 중고구독: '중고구독',
  픽업구독: '픽업구독', 오플구독: '오플구독',
  오공구독: '오공구독', 손오공구독: '오공구독', '손오공 구독': '오공구독',
  신차렌트: '신차렌트', 신차구독: '신차구독',
};
