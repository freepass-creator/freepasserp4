...
export const WHITELABELS: Whitelabel[] = [
   ...
   */
  {
    ...
    notice: {
      /*
       * ★★**배너가 «혜택»을 든다**(사장님 2026-09-17 「밑에 배너에 신용점수 관계 없이 누구나
       *   가능합니다 이런 식으로 **배너도 활용**하자」). 머리띠는 「장기렌터카 상품찾기」로 짧게 두고,
       *   손님이 제일 먼저 궁금해하는 «내가 될까?»를 바로 밑에서 답한다 — 자리를 나눈 것이다.
       * ⚠ 본문의 조건은 **지어내지 않는다** — 채널 배너가 이미 쓰는 그 말(신용회생·신용불량 무관 ·
       *   만 21세 이상)을 그대로 쓴다. 실측 2026-09-17 재고 687대 중 무심사 632(92%)가 이 말을 받친다.
       * ★표준라벨에만 바꾼다 — 채널 간판의 배너는 그 회사 말이라 여기서 안 건드린다.
       */
      title: '신용점수 관계 없이 누구나 가능합니다',
      body: '신용회생·신용불량과 무관하게 만 21세 이상이면 이용하실 수 있습니다. 보증금과 월 대여료를 확인하고 편하게 골라 보세요.',
    },
  },
  {
    key: 'uniplan',
