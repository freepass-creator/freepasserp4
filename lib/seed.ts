...
const RAW_PRODUCTS: EntityRecord[] = [
  ...
  // 인수형(만기 인수) 표본 — 손오공 구독형: 표준(반납형) 12~36 + 36/48/60 인수형. 라인업 「인수형(만기 인수)」 칩·상세 인수형 표 확인용(2026-08-18).
  { product_code: 'veh_1007', car_number: '375어8056', maker: '기아', model: '카니발', sub_model: '카니발 KA4', variant: '2.2 디젤', trim_name: '프레스티지', vehicle_class: '대형 RV', year: '2022', fuel_type: '디젤', mileage: 41000, ext_color: '화이트', int_color: '블랙', options: '내비게이션,어라운드뷰,전동슬라이딩도어,스마트키', vehicle_status: '출고가능', product_type: '중고구독', provider_company_code: 'sup_hanbit', _policy: POL_무관, price: { '12': { rent: 1150000, deposit: 1150000, fee: 0 }, '24': { rent: 1090000, deposit: 2180000, fee: 0 }, '36': { rent: 1050000, deposit: 3150000, fee: 0 }, '36_인수형': { rent: 1290000, deposit: 3870000, fee: 0 }, '48_인수형': { rent: 1190000, deposit: 4760000, fee: 0 }, '60_인수형': { rent: 1090000, deposit: 5450000, fee: 0 } } },
...
export const SAMPLE_CONTRACTS: EntityRecord[] = [
  { contract_code: 'TMP-260620-01', contract_status: '계약발송', contract_date: '2026-06-20', product_code: 'veh_1001', car_number_snapshot: '123가4567', maker_snapshot: '기아', sub_model_snapshot: '스포티지 NQ5', rent_month_snapshot: 36, rent_amount_snapshot: 690000, deposit_amount_snapshot: 0, customer_name: '김민수', customer_phone: '010-2211-3344', agent_uid: 'usr_park', agent_code: 'usr_park', agent_channel_code: 'chn_seoul', provider_company_code: 'sup_jeil', credit_grade_snapshot: '무심사', agent_delivery_inquiry: 'yes', provider_delivery_response: '출고 가능', agent_docs_submitted: 'yes', provider_docs_review: '승인', agent_balance_paid: 'yes' },
  { contract_code: 'TMP-260710-01', contract_status: '계약요청', contract_date: '2026-07-10', product_code: 'veh_1003', car_number_snapshot: '88조1234', maker_snapshot: '기아', sub_model_snapshot: '모닝', rent_month_snapshot: 36, rent_amount_snapshot: 420000, deposit_amount_snapshot: 840000, customer_name: '박준호', customer_phone: '010-3322-1100', agent_uid: 'usr_lee', agent_code: 'usr_lee', agent_channel_code: 'chn_busan', provider_company_code: 'sup_hanbit', credit_grade_snapshot: '무심사', agent_delivery_inquiry: 'yes', provider_delivery_response: '출고 협의' },
  { contract_code: 'TMP-260505-01', contract_status: '계약완료', contract_date: '2026-05-05', product_code: 'veh_1002', car_number_snapshot: '77무5678', maker_snapshot: '기아', sub_model_snapshot: '셀토스', rent_month_snapshot: 36, rent_amount_snapshot: 640000, deposit_amount_snapshot: 0, customer_name: '최지우', customer_phone: '010-9090-1212', agent_uid: 'usr_park', agent_code: 'usr_park', agent_channel_code: 'chn_seoul', provider_company_code: 'sup_jeil', credit_grade_snapshot: '무심사', agent_delivery_inquiry: 'yes', provider_delivery_response: '출고 가능', agent_docs_submitted: 'yes', provider_docs_review: '승인', provider_agreement_done: 'yes', provider_agreement_sent: 'yes', agent_balance_paid: 'yes', agent_final_paid: 'yes', provider_balance_confirmed: 'yes', agent_handover_confirmed: 'yes', provider_release_completed: 'yes' },
];
...
const SEED_VERSION = 'v7-acquisition';
