...
export const INVENTORY_SOURCES: readonly InventorySourceSpec[] = Object.freeze([
  ...
  { partnerCode: 'RP012', name: '손오공', kind: 'erp_api', adapterId: 'sonogong', sourceUrl: 'https://sokrc.com/api', projection: { spreadsheetId: '1WIFn5ObK_nCVGLTjj6rO96i6vxub1QzJmiVW0BpJLcA', tabs: ['구독재고', '픽업재고'] }, channels: ['LOW_SONOKONG_DAILY', 'LOW_SONOKONG', 'LOW_TCAR'] },
