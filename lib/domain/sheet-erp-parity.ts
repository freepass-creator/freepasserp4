...
export const SHEET_ERP_PARITY_RULES: ParityRule[] = [
  ['① ERP 가 읽는 원본',
    '**영업자 상품리스트(판매시트) 4탭**(상품리스트·손오공상품·픽업구독·오플구독)만 그대로 읽는다. 상품마스터·차종마스터 우회 경로는 없다.',
  ...
  ['④ 시트 「계약중」의 뜻',
    'ERP 도 **계약중 그대로** 둔다(예전엔 출고불가로 투영해 목록에서 사라졌다 — 실측 손오공상품 2대). ERP 계약 엔진의 락은 이와 별개이고 시트가 만들지도 풀지도 못한다.',
...
export const SHEET_ERP_PARITY_SUMMARY =
  '판매시트(영업자 표)와 ERP 는 같은 표를 본다. ERP 는 판매시트 4탭을 그대로 읽고(상품마스터 안 거침), '
