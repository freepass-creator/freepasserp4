...
export const POLICY_DEFAULTS: PolicyDefault[] = [
  ...
  {
    key: 'rental_card_payment', label: '대여료카드', value: '협의',
    // ★한 칸에 「불가」 아니면 수수료율(2026-08-21). 율은 공급사마다 달라 기본값으로 못 박지 않는다.
    source: '프리패스 기본정책 — 대여료 카드 수납은 공급사별 협의',
  },
  {
  ...
  {
    key: 'extra_deductibles', label: '추가 면책금',
    value: '해당 없음 (단독사고·휠/타이어·연령 등 사유 발생 시 항목별 부과)',
    // 기존 A4 계약서의 기본 표시문을 정책값으로 고정해 봉인 완료본에서 빈칸이 되지 않게 한다.
    source: '계약서 자차 처리 표의 기존 기본 표시문',
  },
