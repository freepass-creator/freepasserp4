 ...
 * `solo`  = **혼자 설 때**(걸린 조건 칩). 축 제목이 옆에 없으므로 값이 «스스로» 무엇인지 말해야 한다.
 *           사장님 2026-09-06 「거기 뭐 **월 대여료 · 보증금 · 기간 넣을 필요 없어. 딱 보면 알지**」
 *           — 칩 안의 «회색 축 앞머리»를 걷으라는 말이다. 그래서 앞머리는 없애되,
 *           대여료·보증금·주행은 **숫자만 남으면 서로 못 가린다**(「100~200만원」이 대여료인지
 *           보증금인지). ⇒ 값의 «제 이름»에 `월`·`보증금`·`주행` 한 마디를 담는다.
 *           빠른 조건 칩이 이미 그렇게 말한다(「월 50만원 이하」·「보증금 0원」).
...
export const RENT_BANDS: Band[] = [
  { k: 'r50', label: '50만↓', shop: '50만원 이하', solo: '월 50만원 이하', lo: 0, hi: 500000 },
  { k: 'r60', label: '50~60만', shop: '50~60만원', solo: '월 50~60만원', lo: 500000, hi: 600000 },
  { k: 'r70', label: '60~70만', shop: '60~70만원', solo: '월 60~70만원', lo: 600000, hi: 700000 },
  { k: 'r80', label: '70~80만', shop: '70~80만원', solo: '월 70~80만원', lo: 700000, hi: 800000 },
  { k: 'r90', label: '80~90만', shop: '80~90만원', solo: '월 80~90만원', lo: 800000, hi: 900000 },
  { k: 'r100', label: '90~100만', shop: '90~100만원', solo: '월 90~100만원', lo: 900000, hi: 1000000 },
  { k: 'r150', label: '100~150만', shop: '100~150만원', solo: '월 100~150만원', lo: 1000000, hi: 1500000 },
  { k: 'r200', label: '150만↑', shop: '150만원 이상', solo: '월 150만원 이상', lo: 1500000, hi: Infinity },
];
export const DEP_BANDS: Band[] = [
  /* ★축 이름이 이미 「보증금」이다 — 라벨에 「보증」을 또 쓰면 「보증0」 같은 말이 된다(2026-09-05).
     그래서 `shop`(축 밑)은 「없음」이고, `solo`(혼자 설 때)만 「보증금 없음」이다. */
  { k: 'd0', label: '없음', shop: '없음', solo: '보증금 없음', lo: -1, hi: 1 },
  { k: 'd1', label: '100만↓', shop: '100만원 이하', solo: '보증금 100만원 이하', lo: 1, hi: 1000000 },
  { k: 'd2', label: '100~200만', shop: '100~200만원', solo: '보증금 100~200만원', lo: 1000000, hi: 2000000 },
  { k: 'd3', label: '200~300만', shop: '200~300만원', solo: '보증금 200~300만원', lo: 2000000, hi: 3000000 },
  { k: 'd4', label: '300만↑', shop: '300만원 이상', solo: '보증금 300만원 이상', lo: 3000000, hi: Infinity },
];
export const MILE_BANDS: Band[] = [
  { k: 'm1', label: '1만km↓', shop: '1만km 이하', solo: '주행 1만km 이하', lo: -1, hi: 10000 },
  { k: 'm3', label: '1~3만', shop: '1~3만km', solo: '주행 1~3만km', lo: 10000, hi: 30000 },
  { k: 'm5', label: '3~5만', shop: '3~5만km', solo: '주행 3~5만km', lo: 30000, hi: 50000 },
  { k: 'm10', label: '5~10만', shop: '5~10만km', solo: '주행 5~10만km', lo: 50000, hi: 100000 },
  { k: 'm99', label: '10만↑', shop: '10만km 이상', solo: '주행 10만km 이상', lo: 100000, hi: Infinity },
];
