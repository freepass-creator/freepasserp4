...
export const FIELD_MAP: FieldMap[] = [
  ...
  { field: 'late_fee_rate', label: '지연손해금율', from: '정책', atom: 'late_fee_rate', note: '표준 24% · 관계 법령상 허용 한도 내' },
  ...
  { field: 'drv2_name', label: '추가운전자2 성함', from: '입력', conditional: '추가운전자2' },
  { field: 'drv2_relation', label: '추가운전자2 관계', from: '입력', conditional: '추가운전자2' },
  { field: 'drv2_phone', label: '추가운전자2 연락처', from: '입력', conditional: '추가운전자2' },
  ...
  { field: 'special_terms', label: '특약사항', from: '고정', note: 'GPS 무단 탈거·훼손 금지' },
