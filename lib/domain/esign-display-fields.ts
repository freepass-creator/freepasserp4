...
export const DISPLAY_SECTIONS: DisplaySection[] = [
  {
    ...
    fields: [
      ...
      f('customer_id', '주민등록번호', '본인확인', true, 'rrn', 'none', '우리는 저장하지 않는다'),
  ...
  },
  {
    ...
    fields: [
      ...
      f('odometer_delivery', '현재 주행거리', '재고', true),
  ...
  },
  {
    ...
    fields: [
      ...
      f('over_mileage_rate', '초과 주행요금', '정책', true),
  ...
  },
  {
    ...
    fields: [
      ...
      f('auto_debit_date', '자동이체일', '입력', true),
    ],
  },
  {
    key: 'guarantor',
